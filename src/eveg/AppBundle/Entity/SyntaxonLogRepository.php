 ...
 */
class SyntaxonLogRepository extends EntityRepository
{
    /**
    ...
    /**
     * Loads all log entry for the given class name (force unique objectId)
     *
     * @param string $objectClassName
     *
     * @return LogEntry[]
     */
    public function getUniqueLogEntriesByClassName($objectClassName)
    {
        $qb = $this->createQueryBuilder('s');

        $qb->select('s')
           ->where('s.objectClass = :objectClassName')
           ->groupBy('s.objectId')
           ->setParameter('objectClassName', $objectClassName)
           ;
    ...
    /**
     * Counts all log entry for the given class name (force unique objectId)
     *
     * @param string $objectClassName
     *
     * @return LogEntry[]
     */
    public function countUniqueLogEntriesByClassName($objectClassName)
    {
        $qb = $this->createQueryBuilder('s');

        $qb->select('s.objectId, COUNT(s)')
           ->where('s.objectClass = :objectClassName')
           ->groupBy('s.objectId')
           ->setParameter('objectClassName', $objectClassName)
           ;
    ...
    /**
     * Loads all log entry for the given class name by object id
     *
     ...
     * @return LogEntry[]
     */
    public function findById($objectId, $objectClassName)
    {
        $qb = $this->createQueryBuilder('s');
